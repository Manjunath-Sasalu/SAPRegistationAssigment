...
public class ExtentReportManager implements ITestListener
{
	...
	{		
		...
		htmlReporter.config().setDocumentTitle("SAP Registartion Automation Report"); // Tile of report
		htmlReporter.config().setReportName("SAP  Functional Testing"); // name of the report
